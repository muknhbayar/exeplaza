    ...
    <div className="flex justify-center m-0 md:p-16">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="pl-16">
          ...
          <p className="font-light mt-4 font-sans text-gray-800 max-w-lg mr-16">
          ...
          <a
            className="inline-block px-6 py-4 my-4 bg-sky-500 text-white font-light text-sm leading-snug uppercase rounded hover:bg-sky-400 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
            href="#!"
            role="button"
